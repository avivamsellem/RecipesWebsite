  ...
  <div class="container">
    ...
    <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
      ...
      >
        ...
        >First name length should be between at least 2 characters long</b-form-invalid-feedback>
      </b-form-group>
      ...
      >
        ...
        >Last name length should be between at least 2 characters long</b-form-invalid-feedback>
      </b-form-group>
      ...
      >
        ...
        <b-form-invalid-feedback v-if="!$v.form.password.valid">
          <li>contains at list 1 special charcter and 1 digit.</li>
        </b-form-invalid-feedback>
      </b-form-group>
      ...
      >
        ...
        ></b-form-input>
        <b-form-invalid-feedback
          v-if="!$v.form.profileImage.required"
        >Link to profile image is required</b-form-invalid-feedback>
        <b-form-invalid-feedback
          v-else-if="!$v.form.profileImage.url"
        >Link is not a valid url</b-form-invalid-feedback>
      </b-form-group>
    ...
    async Register() {
      try {
        const response = await this.axios.post(
          "https://server-attackonrecipes.herokuapp.com/user/register",
          {
